...
public final class GetVolumesListFromMyBookshelf {
    @NotBlank
    private String bookshelfId;

    public GetVolumesListFromMyBookshelf(String bookshelfId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumesListFromMyBookshelf that)) return false;
    ...
    public String toString() {
        return "GetVolumesListFromMyBookshelf{" +
