...
public final class GetVolumesListFromPublicBookshelfByUserId {
    @NotBlank
    private String userId;
    @NotBlank
    private String bookshelfId;

    public GetVolumesListFromPublicBookshelfByUserId(String userId, String bookshelfId) {
        this.userId = userId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GetVolumesListFromPublicBookshelfByUserId that)) return false;
    ...
    public String toString() {
        return "GetVolumesListFromPublicBookshelfByUserId{" +
                "userId='" + userId + '\'' +
